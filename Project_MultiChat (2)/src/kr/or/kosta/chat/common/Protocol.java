...
public interface Protocol {
	...
	public static final int ROOM_LIST_RESET = 2100; //대화방 목록 갱신
	...
	public static final int ROOM_OUT = 2500; // 대화방 퇴장
	
	
	public static final int ALL_USER_LIST = 3100; // 모든(접속중인) 대기실 + 채팅방 안 사용자 목록
	public static final int WAIT_USER_LIST = 3200; // 대기실에 있는 사용자 목록
	...
	public static final int ROOM_IN = 4404; // 채팅방 입장
