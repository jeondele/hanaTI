...
public class ChatServer {
	...
	public void sendPartialMessage(String nickName, String sendTo, String message) {
		Enumeration<Client> clients = getClients().elements();
	...
	public void removeRoom(Room room) {
		...
		for (int i = 0; i < roomList.size(); i++) {
			...
			message += (Protocol.DELEMETER + /** owner + */
					Protocol.DELEMETER + idx + Protocol.DELEMETER + title + Protocol.DELEMETER + userLimit);
		}
