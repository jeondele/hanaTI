...
public class Client extends Thread {
	...
	public void process(String message) {
		...
		case Protocol.CONNECT:
			...
			if(chatServer.isExistNickName(nickName)) {
				...
				chatServer.sendAllMessage(Protocol.CONNECT_RESULT + Protocol.DELEMETER + nickName + Protocol.DELEMETER +  "SUCCESS");
				sendUserList();
			}
			break;
	...
	public void sendUserList() {
		...
		String message = String.valueOf(Protocol.MULTI_LIST);
